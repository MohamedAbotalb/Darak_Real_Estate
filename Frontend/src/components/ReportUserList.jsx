...
import { fetchReports, deleteReport, deleteLandlord } from '../store/reportUsersSlice';
          ...
          <TableBody>
            {reports.map((report) => (
              <StyledTableRow key={report.id}>
                ...
                <StyledTableCell align="center">{report.user.first_name+" "+report.user.last_name}</StyledTableCell>
                <StyledTableCell align="center">{report.landlord.first_name+" "+report.landlord.last_name}</StyledTableCell>
                <StyledTableCell align="center">{report.content}</StyledTableCell>
