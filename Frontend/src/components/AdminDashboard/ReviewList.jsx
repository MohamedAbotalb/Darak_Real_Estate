...
function ReviewList() {
  ...
  const filteredReviews = reviews.filter((review) => {
    ...
    const matchesDateSearchTerm =
      dateSearchTerm === '' ||
      new Date(review.created_at).toLocaleDateString() === dateSearchTerm;
    return (
      matchesSearchTerm && matchesRateSearchTerm && matchesDateSearchTerm
    );
  });
        ...
        <Box display="flex" justifyContent="between">
          ...
          <Search>
            ...
            <StyledInputBase
              ...
              inputProps={{ 'aria-label': 'search date' }}
